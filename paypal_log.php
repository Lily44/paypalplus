                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="datatables_list"> 
                        ...
                        <tbody>
                            ...
                            <tr class="<?php echo $odd_even;?>">
                                ...
                                <td><?php echo $logs['f_amount']; echo $logs['s_currency_code']; ?></td>
                            	<td><?php echo $logs['s_email']; ?></td>
                            	<td><?php echo $logs['fk_i_user_id']; ?></td>
                            	<td><?php echo $logs['fk_i_item_id']; ?></td>
                                <td><?php echo $logs['s_source']; ?></td>
                            	<td><?php if ($logs['i_product_type']=='201') echo _e('Premium Ads', 'paypalplus');
											else if ($logs['i_product_type']=='301') echo _e('PremiumPlus Ads', 'paypalplus');
											else if ($logs['i_product_type']=='401') echo _e('Pack','paypalplus');
								 ?></td>
                            </tr>
                            <?php }?>
                        </tbody>
